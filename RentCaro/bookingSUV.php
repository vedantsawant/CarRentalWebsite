        ...
        <div class="row">
            ...
            <div class="col-md-7">
              <script src="car.js"></script>
                ...
                $query = "SELECT avail,model FROM car where category='SUV' and avail=1 ";
               ...
               <br>
                ...
                <form method="POST" action="bookingpg.php">
                     <button type="button" style="margin:1rem 0;" class="btn btn-primary cart" onclick="document.location.href='bookingpg.php' <?php $_SESSION['car_model'] = $myvalue; ?>">Book Now</button>
                </form>
